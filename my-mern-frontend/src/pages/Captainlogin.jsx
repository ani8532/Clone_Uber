...
const Captainlogin = () => {
  ...
  return (
    <div>
        ...
        <div>
        <img className='w-16 mb-10' src="http://pluspng.com/img-png/uber-logo-vector-png-uber-icon-png-50-px-1600.png" alt="" />
      ...
      <p className='text-center'>Want to Ride as Uber-Partner</p><Link to='/captainsignup' className='text-blue-600 flex items-center justify-center '>Register as Partner </Link>
